...
namespace MMVII
{
    ...
    cGaussF2D::cGaussF2D(const cPt2dr &aC, double aSigm) : mC(aC),
                                                           mSigm(aSigm)
    {
    }
    ...
    cGaussF2D::cGaussF2D(const cGaussF2D &aG, const cHomot2D<tREAL8> &aH) : cGaussF2D(
                                                                                (aG.mC - aH.Tr()) / aH.Sc(),
                                                                                aG.mSigm / aH.Sc())
    {
    }
    ...
    cTestDeformIm::cTestDeformIm(int aSzGlob, double aEps, bool Show) : mShow(Show),
