...
namespace MMVII
{
    ...
    template <class Type>
    const std::vector<cTriangle<Type, 2>> &SplitPixIn2(bool DiagCrois)
    {
    ...
    template <class Type>
    cTriangle2DCompiled<Type>::cTriangle2DCompiled(const cTriangle<Type, 2> &aTri) : cTriangle<Type, 2>(aTri)
    {
    ...
    template <class Type>
    cTriangle2DCompiled<Type>::cTriangle2DCompiled(const tPt &aP0, const tPt &aP1, const tPt &aP2) : cTriangle2DCompiled<Type>(cTriangle<Type, 2>(aP0, aP1, aP2))
    {
    }

    template <class Type>
    bool cTriangle2DCompiled<Type>::Regular() const { return mDelta != 0; }

    template <class Type>
    void cTriangle2DCompiled<Type>::AssertRegular() const
    {
        MMVII_INTERNAL_ASSERT_tiny(Regular(), "Non regular triangle");
    }

    template <class Type>
    cTriangle2DCompiled<Type>
    ...
    template <class Type>
    Type cTriangle2DCompiled<Type>::Insideness(const tPt &aPt) const
    {
    ...
    template <class Type>
    bool cTriangle2DCompiled<Type>::Insides(const tPt &aPt, Type aTol) const
    {
    ...
    template <class Type>
    cPtxd<Type, 2> cTriangle2DCompiled<Type>::GradientVI(const t3Val &aValues) const
    {
